...
export default function EditarProdutoPage({ params }: { params: { id: string } }) {
  ...
  // Estado para verificar se os dados foram carregados
  const [isLoading, setIsLoading] = useState(true)
  // Estado para verificar se está salvando
    ...
    return (
      <div className="p-6 flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Carregando informações do produto...</p>
        </div>
      </div>
    )
  }
          ...
          <TabsContent value="informacoes">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Atualize os detalhes básicos do produto</CardDescription>
              </CardHeader>
